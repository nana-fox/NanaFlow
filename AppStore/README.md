...
App Store Connect has finished processing build 2 and reports it as ready to submit. The initial price is free. Availability was configured for all 175 storefronts and submitted for confirmation; the final page readback is still being rechecked. This evidence does **not** yet claim store installation, Widget Gallery/App Group runtime verification, migration verification, screenshot acceptance, privacy-answer publication, or App Review approval. Those remain explicit release gates. Named third-party quotations were removed from build 2 so the shipped Widget text is NanaFlow-authored.
