...
Still open: attachment of build 2 to version 1.0, final readback of the submitted 175-storefront availability, mainland-China compliance follow-up, screenshots, English localization entry, privacy publication attestation, signed distribution installation, Widget Gallery/App Group runtime verification, migration verification, and final App Review submission. The price is free, and the EU DSA non-trader declaration is valid. Final submission requires explicit developer confirmation.
