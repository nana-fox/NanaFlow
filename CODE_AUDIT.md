...
- App Store Connect 已确认全部 175 个国家或地区可用；构建 `1.0.0 (2)` 已关联到 macOS 1.0 并保存。
- App Store Connect 的欧盟 DSA 账户级声明已按开发者确认选择“非交易者”，后台显示 27 个欧盟国家或地区、状态“有效”（2026-09-22）。
- 尚未证明：商店候选安装、真实沙盒数据迁移、Widget Gallery/App Group 运行时共享。截图、缺失的简体中文描述、隐私声明发布和最终提审仍是发布门禁；免费定价、175 区供应、有效的免费 App 协议和构建 2 关联已经确认。
